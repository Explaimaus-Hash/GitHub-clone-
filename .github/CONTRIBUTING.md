...
- For questions, ask in [Discussions](https://github.com/Explaimaus-Hash/GitHub-clone-/discussions).
- [Check to make sure](https://docs.github.com/en/github/searching-for-information-on-github/searching-on-github/searching-issues-and-pull-requests#search-by-the-title-body-or-comments) someone hasn't already opened a similar [issue](https://github.com/Explaimaus-Hash/GitHub-clone-/issues).
- If a similar issue doesn't exist, open a new issue using a relevant [issue form](https://github.com/Explaimaus-Hash/GitHub-clone-/issues/new/choose).
- Blank issues that are not coming from maintainers will be closed without a response.

### Pick up an issue to solve

- Scan through our [existing issues](https://github.com/Explaimaus-Hash/GitHub-clone-/issues) to find one that interests you.
- The [👋 good first issue](https://github.com/Explaimaus-Hash/GitHub-clone-/issues?q=is%3Aissue+is%3Aopen+label%3A%22%F0%9F%91%8B+good+first+issue%22) is a good place to start exploring issues that are well-groomed for newcomers.
