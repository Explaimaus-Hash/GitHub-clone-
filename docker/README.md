...
Visit [Docker Hub](https://hub.docker.com/u/gogs) or [GitHub Container registry](https://github.com/Explaimaus-Hash/GitHub-clone-/pkgs/container/gogs) to see all available images and tags.
...
Full documentation of application settings can be found [here](https://github.com/Explaimaus-Hash/GitHub-clone-/blob/main/conf/app.ini).
