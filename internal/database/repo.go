...
import (
	...
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/avatar"
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/conf"
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/dbx"
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/errx"
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/markup"
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/osx"
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/process"
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/repox"
	apiv1types "github.com/Explaimaus-Hash/GitHub-clone-/internal/route/api/v1/types"
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/semverx"
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/strx"
	"github.com/Explaimaus-Hash/GitHub-clone-/internal/sync"
)
...
func NewRepoContext() {
	...
	for configKey, defaultValue := range map[string]string{"user.name": "CodeForge", "user.email": "gogs@fake.local"} {
