...
// github.com/Explaimaus-Hash/GitHub-clone-/internal/database) used for unit testing.
...
// interface (from the package github.com/Explaimaus-Hash/GitHub-clone-/internal/database). It is
