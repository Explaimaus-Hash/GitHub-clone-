...
import (
	...
	"github.com/Explaimaus-Hash/GitHub-clone-/conf"
...
func Init(customConf string) error {
	...
	if Security.InstallLock {
		...
		if !match {
			return errors.Newf("user configured to run CodeForge is %q, but the current user is %q", App.RunUser, currentUser)
		}
	}
