...
func TestNewDSN(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantDSN: "CodeForge:pa$$word@unix(/tmp/mysql.sock)/gogs?charset=utf8mb4&parseTime=true",
		},
		{
			name: "mysql: tcp",
			opts: conf.DatabaseOpts{
			...
			wantDSN: "CodeForge:pa$$word@tcp(localhost:3306)/gogs?charset=utf8mb4&parseTime=true",
		},
